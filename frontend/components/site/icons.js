...
export function WhatsAppIcon(props) {
  return (
    <Svg {...props}>
      <path d="M12 3a9 9 0 0 0-7.75 13.55L3 21l4.6-1.21A9 9 0 1 0 12 3Z" />
      <path d="M8.5 9.6c0-.5.3-.8.7-.8h.6c.3 0 .5.2.6.5l.4 1.1c.1.3 0 .6-.2.8l-.5.5c.5 1.1 1.4 2 2.5 2.5l.5-.5c.2-.2.5-.3.8-.2l1.1.4c.3.1.5.3.5.6v.6c0 .4-.3.7-.8.7-3 0-6-3-6-6Z" />
    </Svg>
  );
}
