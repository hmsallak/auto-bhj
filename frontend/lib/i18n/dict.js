...
export const DICT = {
  fr: {
    ...
    rdv: {
      ...
      pastBadge: "Rendez-vous passé",
      title: "À bientôt,",
      intro: "Votre rendez-vous chez Auto BHJ est bien enregistré. Voici tout ce qu'il faut savoir.",
      pastTitle: "Ce rendez-vous est passé",
      pastIntro: "Merci de votre visite. Pour un nouveau rendez-vous, contactez-nous.",
      car: "Véhicule",
      note: "Note",
      address: "Adresse",
  ...
  nl: {
    ...
    rdv: {
      ...
      pastBadge: "Afspraak voorbij",
      title: "Tot binnenkort,",
      intro: "Uw afspraak bij Auto BHJ is geregistreerd. Hier vindt u alles wat u moet weten.",
      pastTitle: "Deze afspraak is voorbij",
      pastIntro: "Bedankt voor uw bezoek. Neem contact met ons op voor een nieuwe afspraak.",
      car: "Wagen",
      note: "Opmerking",
      address: "Adres",
